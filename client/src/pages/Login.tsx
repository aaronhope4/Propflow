  ...
  const loginMutation =
    trpc.auth.login.useMutation({
      onSuccess: async (
        ...
        /**
         * Store the JWT fallback token.
         *
         * This allows authentication to
         * continue when the browser blocks
         * the cross-site Render cookie.
         */
        if (
          data.sessionToken
        ) {
        ...
        <div className="space-y-8">
          ...
          <div>
            ...
            <p className="text-sidebar-foreground/60 text-lg leading-relaxed">
              ...
              platform for modern landlords and
              property managers.
            </p>
          </div>
            ...
            {[
              ...
              },
              {
                ...
                title:
                  "Role-Based Access",
                desc:
                  "Secure access for managers and tenants",
              },
            ].map(
              ({
                icon: Icon,
        ...
        <div className="w-full max-w-sm space-y-8 animate-fade-in">
          ...
          <div className="border-t border-border pt-6 space-y-3">
            ...
            <p className="text-xs text-muted-foreground text-center">
              Tenants: use the invite link sent by
