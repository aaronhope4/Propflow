...
async function startServer() {
  ...
  // Scheduled job endpoints — must be registered before Vite/static fallthrough
  app.post("/api/scheduled/invite-expiry-reminder", inviteExpiryReminderHandler);
  app.post("/api/scheduled/vendor-insurance-reminder", vendorInsuranceReminderHandler);
